...
router.post('/token', (req, res) => {
  ...
  router.use('/getAll', require('../Services/functionsForFarm/getAll'))
  router.use('/delete', require('../Services/functionsForFarm/delete'))
  router.use('/update', require('../Services/functionsForFarm/update'))
  router.use('/get', require('../Services/functionsForFarm/getById'))
